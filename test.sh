...
#python 运行程序
DETECTRON2_DATASETS=/home/bingxing2/gpuuser206/mmdetection/data python train_net.py --dist-url 'tcp://127.0.0.1:50164' \
    --num-gpus 8 \
    --config-file configs/coco/swin/oneformer_swin_large_bs16_100ep.yaml \
    --eval-only MODEL.IS_TRAIN False MODEL.WEIGHTS checkpoints/150_16_swin_l_oneformer_coco_100ep.pth \
    MODEL.TEST.TASK panoptic
DETECTRON2_DATASETS=/home/bingxing2/gpuuser206/mmdetection/data python train_net.py --dist-url 'tcp://127.0.0.1:50164' \
    --num-gpus 8 \
    --config-file configs/coco/swin/oneformer_swin_large_bs16_100ep.yaml \
    --eval-only MODEL.IS_TRAIN False MODEL.WEIGHTS checkpoints/150_16_swin_l_oneformer_coco_100ep.pth \
    MODEL.TEST.TASK instance
DETECTRON2_DATASETS=/home/bingxing2/gpuuser206/mmdetection/data python train_net.py --dist-url 'tcp://127.0.0.1:50164' \
    --num-gpus 8 \
    --config-file configs/coco/swin/oneformer_swin_large_bs16_100ep.yaml \
    --eval-only MODEL.IS_TRAIN False MODEL.WEIGHTS checkpoints/150_16_swin_l_oneformer_coco_100ep.pth \
    MODEL.TEST.TASK semantic
# DETECTRON2_DATASETS=/home/bingxing2/gpuuser206/mmdetection/data python train_net.py --dist-url 'tcp://127.0.0.1:50164' \
#     --num-gpus 8 \
#     --config-file configs/coco/dinat/oneformer_dinat_large_bs16_100ep.yaml \
#     --eval-only MODEL.IS_TRAIN False MODEL.WEIGHTS checkpoints/150_16_dinat_l_oneformer_coco_100ep.pth \
#     MODEL.TEST.TASK panoptic
# DETECTRON2_DATASETS=/home/bingxing2/gpuuser206/mmdetection/data python train_net.py --dist-url 'tcp://127.0.0.1:50164' \
#     --num-gpus 8 \
#     --config-file configs/coco/dinat/oneformer_dinat_large_bs16_100ep.yaml \
